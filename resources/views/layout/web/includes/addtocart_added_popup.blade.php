<div id="pro-addtocart-popup" class="mfp-with-anim mfp-hide">
    ...
    <div class="addtocart-inner text-center clearfix">
        <h4 class="title mb-3 text-success">
            Added to your shopping cart successfully.
        </h4>
        <div class="pro-img mb-3">
            <img class="img-fluid blur-up lazyload" src="{{asset('assets/images/products/add-to-cart-popup.jpg')}}"
                data-src="{{asset('assets/images/products/add-to-cart-popup.jpg')}}"
