...
@section('content')
    ...
    <body class="category-page category-7columns">
        <!-- Page Loader -->
        ...
        <div class="page-wrapper">
            ...
            <div id="page-content">
                ...
                <div class="collection-header">
                    <div class="collection-hero">
                        ...
                        <div class="collection-hero__title-wrapper container">
                            <h1 class="collection-hero__title">Category 7 Columns</h1>
                            <div class="breadcrumbs text-uppercase mt-1 mt-lg-2"><a href="index.html"
                                    title="Back to the home page">Home</a><span>|</span><span class="fw-bold">Category
                                    7 Columns</span></div>
                        </div>
                    </div>
                </div>
                ...
                <!--Category Grid-->
                <div class="container-full px-3 clearfix">
                    <!--Category Masonary Grid-->
                    <div class="grid-categorys grid-mr-10">
                        <div class="grid-masonary category-page-grid style5">
                            <div class="grid-sizer col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 grid-7col"></div>
                            <div class="row grid-7col mx-0">
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 category-grid-item cl-item">
                                    <div class="category-item position-relative overflow-hidden zoomscal-hov">
                                        <a href="shop-left-sidebar.html" class="category-link">
                                            <div class="zoom-scal"><img class="blur-up lazyload"
                                                    data-src="assets/images/collection/collection1.jpg"
                                                    src="assets/images/collection/collection1.jpg" alt="collection"
                                                    title="" /></div>
                                            <div class="details text-center px-0">
                                                <div class="inner">
                                                    <div class="default">
                                                        <h3 class="category-title">Women</h3>
                                                        <span class="counts mt-0 mt-md-1">20 Products</span>
                                                    </div>
                                                    <div class="hover">
                                                        <p class="detail text-dark mt-1 mb-2">Add description your chosen
                                                            collection</p>
                                                        <span class="btn rounded btn--small">shop now</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 category-grid-item cl-item">
                                    <div class="category-item position-relative overflow-hidden zoomscal-hov">
                                        <a href="shop-left-sidebar.html" class="category-link">
                                            <div class="zoom-scal"><img class="blur-up lazyload"
                                                    data-src="assets/images/collection/collection2.jpg"
                                                    src="assets/images/collection/collection2.jpg" alt="collection"
                                                    title="" /></div>
                                            <div class="details text-center px-0">
                                                <div class="inner">
                                                    <h3 class="category-title">Kids</h3>
                                                    <span class="counts mt-0 mt-md-1">24 Products</span>
                                                    <p class="detail text-dark mt-1 mb-2">Add description your chosen
                                                        collection</p>
                                                    <span class="btn rounded btn--small">shop now</span>
                                                </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 category-grid-item cl-item">
                                    <div class="category-item position-relative overflow-hidden zoomscal-hov">
                                        <a href="shop-left-sidebar.html" class="category-link">
                                            <div class="zoom-scal"><img class="blur-up lazyload"
                                                    data-src="assets/images/collection/collection3.jpg"
                                                    src="assets/images/collection/collection3.jpg" alt="collection"
                                                    title="" /></div>
                                            <div class="details text-center px-0">
                                                <div class="inner">
                                                    <h3 class="category-title">Men</h3>
                                                    <span class="counts mt-0 mt-md-1">32 Products</span>
                                                    <p class="detail text-dark mt-1 mb-2">Add description your chosen
                                                        collection</p>
                                                    <span class="btn rounded btn--small">shop now</span>
                                                </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 category-grid-item cl-item">
                                    <div class="category-item position-relative overflow-hidden zoomscal-hov">
                                        <a href="shop-left-sidebar.html" class="category-link">
                                            <div class="zoom-scal"><img class="blur-up lazyload"
                                                    data-src="assets/images/collection/collection4.jpg"
                                                    src="assets/images/collection/collection4.jpg" alt="collection"
                                                    title="" /></div>
                                            <div class="details text-center px-0">
                                                <div class="inner">
                                                    <h3 class="category-title">Shoes &amp; Bags</h3>
                                                    <span class="counts mt-0 mt-md-1">40 Products</span>
                                                    <p class="detail text-dark mt-1 mb-2">Add description your chosen
                                                        collection</p>
                                                    <span class="btn rounded btn--small">shop now</span>
                                                </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 category-grid-item cl-item">
                                    <div class="category-item position-relative overflow-hidden zoomscal-hov">
                                        <a href="shop-left-sidebar.html" class="category-link">
                                            <div class="zoom-scal"><img class="blur-up lazyload"
                                                    data-src="assets/images/collection/collection5.jpg"
                                                    src="assets/images/collection/collection5.jpg" alt="collection"
                                                    title="" /></div>
                                            <div class="details text-center px-0">
                                                <div class="inner">
                                                    <h3 class="category-title">Deals</h3>
                                                    <span class="counts mt-0 mt-md-1">34 Products</span>
                                                    <p class="detail text-dark mt-1 mb-2">Add description your chosen
                                                        collection</p>
                                                    <span class="btn rounded btn--small">shop now</span>
                                                </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 category-grid-item cl-item">
                                    <div class="category-item position-relative overflow-hidden zoomscal-hov">
                                        <a href="shop-left-sidebar.html" class="category-link">
                                            <div class="zoom-scal"><img class="blur-up lazyload"
                                                    data-src="assets/images/collection/collection6.jpg"
                                                    src="assets/images/collection/collection6.jpg" alt="collection"
                                                    title="" /></div>
                                            <div class="details text-center px-0">
                                                <div class="inner">
                                                    <h3 class="category-title">Accessories</h3>
                                                    <span class="counts mt-0 mt-md-1">26 Products</span>
                                                    <p class="detail text-dark mt-1 mb-2">Add description your chosen
                                                        collection</p>
                                                    <span class="btn rounded btn--small">shop now</span>
                                                </div>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 category-grid-item cl-item">
                                    <div class="category-item position-relative overflow-hidden zoomscal-hov">
                                        <a href="shop-left-sidebar.html" class="category-link">
                                            <div class="zoom-scal"><img class="blur-up lazyload"
                                                    data-src="assets/images/collection/collection7.jpg"
                                                    src="assets/images/collection/collection7.jpg" alt="collection"
                                                    title="" /></div>
                                            <div class="details text-center px-0">
                                                <div class="inner">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2 category-grid-item cl-item d-xl-none">
                                    <div class="category-item position-relative overflow-hidden zoomscal-hov">
                                        <a href="shop-left-sidebar.html" class="category-link">
                                            <div class="zoom-scal"><img class="blur-up lazyload"
                                                    data-src="assets/images/collection/collection8.jpg"
                                                    src="assets/images/collection/collection8.jpg" alt="collection"
                                                    title="" /></div>
                                            <div class="details text-center px-0">
                                                <div class="inner">
                                                    <h3 class="category-title">Home &amp; Living</h3>
                                                    <span class="counts mt-0 mt-md-1">18 Products</span>
                                                    <p class="detail text-dark mt-1 mb-2">Add description your chosen
                                                        collection</p>
                                                    <span class="btn rounded btn--small">shop now</span>
                                                </div>
                ...
                <section class="section product-slider pb-0 clearfix">
                    <div class="container">
                        <div class="row">
                        ...
                        <div class="productSlider grid-products">
                            <div class="item">
                                    ...
                                    <div class="button-set style0 d-none d-md-block">
                                        <ul>
                                            ...
                                            <li><a class="btn-icon compare add-to-compare" href="compare-style2.html"><i
                                                        ...
                                                        class="tooltip-label top">Add to Compare</span></a></li>
                                            <!--End Compare Button-->
                                        </ul>
                                    </div>
                                    <!--End Product Button-->
                                ...
                                <div class="product-details text-center">
                                    ...
                                    <!--End Product Price-->
                                    <!--Product Review-->
                                    <div class="product-review"><i class="an an-star"></i> <i
                            ...
                            <div class="item">
                                ...
                                <div class="product-details text-center">
                                    ...
                                    <ul class="swatches">
                                        ...
                                        <li class="swatch small rounded yellow"><span class="tooltip-label">yellow</span>
                                        </li>
                                    </ul>
                                    <!-- End Variant -->
                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="product-details text-center">
                                    ...
                                    <ul class="swatches">
                                        ...
                                        <li class="swatch small rounded purple"><span class="tooltip-label">Purple</span>
                                        </li>
                                    </ul>
                                    <!-- End Variant -->
                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="product-details text-center">
                                    ...
                                    <ul class="swatches">
                                        ...
                                        <li class="swatch small rounded maroon"><span class="tooltip-label">maroon</span>
                                        </li>
                                    </ul>
                                    <!-- End Variant -->
                                </div>
                ...
                <!--Top Rated Item Slider-->
                <section class="section product-slider pb-0 clearfix">
                    <div class="container">
                        <div class="row">
                            <div class="section-header col-12">
                                <h2 class="text-transform-none">Top Rated Item</h2>
                            </div>
                        </div>
                        <div class="productSlider grid-products">
                            <div class="item">
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload"
                                            data-src="assets/images/products/product-16.jpg"
                                            src="assets/images/products/product-16.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload"
                                            data-src="assets/images/products/product-16-1.jpg"
                                            src="assets/images/products/product-16-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
    ...
    <!-- Mirrored from template.annimexweb.com/optimal/category-7columns.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 May 2022 14:58:22 GMT -->
