...
@section('content')
        ...
        <div class="page-wrapper">
            ...
            <div id="page-content">
                    ...
                    <div class="container">
                        <div class="breadcrumbs">
                            <a href="index.html" title="Back to the home page">Home</a><span>|</span><span
                                class="fw-bold">Product 360 Degree View</span>
                        </div>
                    </div>
                </div>
                <!--End Breadcrumbs-->
                ...
                <div class="container">
                                ...
                                <div class="product-details-img thumb-left clearfix d-flex-wrap mb-3 mb-md-0">
                                    <div class="product-thumb">
                                        <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                            <a data-image="assets/images/products/360degree-images/1.jpg"
                                                data-zoom-image="assets/images/products/360degree-images/1.jpg"
                                                class="slick-slide slick-cloned active">
                                                <img class="blur-up lazyload"
                                                    data-src="assets/images/products/360degree-images/1.jpg"
                                                    src="assets/images/products/360degree-images/1.jpg" alt="product" />
                                            </a>
                                            <a data-image="assets/images/products/360degree-images/5.jpg"
                                                data-zoom-image="assets/images/products/360degree-images/5.jpg"
                                                class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload"
                                                    data-src="assets/images/products/360degree-images/5.jpg"
                                                    src="assets/images/products/360degree-images/5.jpg" alt="product" />
                                            </a>
                                            <a data-image="assets/images/products/360degree-images/10.jpg"
                                                data-zoom-image="assets/images/products/360degree-images/10.jpg"
                                                class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload"
                                                    data-src="assets/images/products/360degree-images/10.jpg"
                                                    src="assets/images/products/360degree-images/10.jpg" alt="product" />
                                            </a>
                                            <a data-image="assets/images/products/360degree-images/15.jpg"
                                                data-zoom-image="assets/images/products/360degree-images/15.jpg"
                                                class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload"
                                                    data-src="assets/images/products/360degree-images/15.jpg"
                                                    src="assets/images/products/360degree-images/15.jpg" alt="product" />
                                            </a>
                                            <a data-image="assets/images/products/360degree-images/20.jpg"
                                                data-zoom-image="assets/images/products/360degree-images/20.jpg"
                                                class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload"
                                                    data-src="assets/images/products/360degree-images/20.jpg"
                                                    src="assets/images/products/360degree-images/20.jpg" alt="product" />
                                            </a>
                                            <a data-image="assets/images/products/360degree-images/25.jpg"
                                                data-zoom-image="assets/images/products/360degree-images/25.jpg"
                                                class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload"
                                                    data-src="assets/images/products/360degree-images/25.jpg"
                                                    src="assets/images/products/360degree-images/25.jpg" alt="product" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="zoompro-wrap product-zoom-right">
                                        <div class="zoompro-span">
                                            <img id="zoompro" class="zoompro"
                                                src="assets/images/products/360degree-images/1.jpg"
                                                data-zoom-image="assets/images/products/360degree-images/1.jpg"
                                                alt="product" />
                                        </div>
                                        <div class="product-labels">
                                            <span class="lbl on-sale">Best seller</span>
                                        </div>
                                        <div class="product-wish">
                                            <a class="wishIcon wishlist rounded m-0" href="my-wishlist.html"><i
                                                    class="icon an an-heart"></i><span class="tooltip-label left">Available
                                                    in Wishlist</span></a>
                                        </div>
                                        <div class="product-buttons">
                                            <a href="https://www.youtube.com/watch?v=93A2jOW5Mog"
                                                class="mfpbox mfp-with-anim btn rounded popup-video"><i
                                                    class="icon an an-video"></i><span class="tooltip-label">Watch
                                                    Video</span></a>
                                            <a href="#" class="btn rounded prlightbox"><i
                                                    class="icon an an-expand-l-arrows"></i><span class="tooltip-label">Zoom
                                                    Image</span></a>
                                            <a href="#threesixty" class="btn rounded pr360view"><i
                                                    class="icon an an-repean-r"></i>
                                                <span class="tooltip-label">360 Product View</span></a>
                                        </div>
                                    </div>
                                    <div class="lightboximages">
                                        <a href="assets/images/products/360degree-images/1.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/products/360degree-images/5.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/products/360degree-images/10.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/products/360degree-images/15.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/products/360degree-images/20.jpg" data-size="1000x1280"></a>
                                        <a href="assets/images/products/360degree-images/25.jpg" data-size="1000x1280"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="product-single__meta">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <p class="product-sku">
                                            SKU: <span class="variant-sku">1416PT-1</span>
                                        </p>
                                    </div>
                                    <!-- End Product Info -->
                                    <!-- Product Price -->
                                    <div class="product-single__price pb-1">
                                        ...
                                        <span class="product-price__sale--single">
                                            <span class="product-price-old-price">$200.00</span><span
                                                class="product-price__price product-price__sale">$225.00</span>
                                        ...
                                        <div class="product__policies fw-normal mt-1">
                                            Tax included.
                                        </div>
                                    </div>
                                    <!-- End Product Price -->
                                    <!-- Countdown -->
                                    <div id="product-countdown" class="saleTime d-flex-center mt-0 mb-3 pb-1"
                                        data-countdown="2024/10/01"></div>
                                    <!-- End Countdown -->
                                    <!-- Product Sold -->
                                    <div class="orderMsg d-flex-center" data-user="23" data-time="24">
                                        <img src="assets/images/order-icon.jpg" alt="order" />
                                        <p class="m-0">
                                            <strong class="items">8</strong> Sold in last
                                            <strong class="time">14</strong> hours
                                        </p>
                                        <p id="quantity_message" class="ms-2 ps-2 border-start">
                                            Hurry! Only <span class="items fw-bold">10</span> left in
                                            stock.
                                        </p>
                                    </div>
                                    <!-- End Product Sold -->
                                ...
                                <form method="post" action="#" class="product-form hidedropdown">
                                    ...
                                    <div class="swatches-image swatch clearfix swatch-0 option1" data-option-index="0">
                                        <div class="product-form__item">
                                            ...
                                            <ul class="swatches d-flex-wrap list-unstyled clearfix">
                                                <li data-value="Green" class="swatch-element color available active">
                                                    <label class="swatchLbl rounded color medium top green"
                                                        title="Green"></label>
                                                    <span class="tooltip-label top">Green</span>
                                                </li>
                                                <li data-value="Red" class="swatch-element color available">
                                                    <label class="swatchLbl rounded color medium top peach"
                                                        title="Peach"></label>
                                                    <span class="tooltip-label top">Peach</span>
                                                </li>
                                                <li data-value="Green" class="swatch-element color available">
                                                    <label class="swatchLbl rounded color medium top white"
                                                        title="White"></label>
                                    ...
                                    <div class="swatch clearfix swatch-1 option2" data-option-index="1">
                                        <div class="product-form__item">
                                            ...
                                            <ul class="swatches-size d-flex-center list-unstyled clearfix">
                                                ...
                                                <li class="ms-1">
                                                    <a href="#sizechart" class="sizelink link-underline text-uppercase"><i
                                                            class="icon an an-ruler d-none"></i> Size
                                                        Guide</a>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                                <div class="product-form__item--submit">
                                                    <button type="submit" name="add"
                                                        class="btn rounded product-form__cart-submit">
                                                        <span>Add to cart</span>
                                                    </button>
                                                    <button type="submit" name="add"
                                                        class="btn rounded product-form__sold-out d-none"
                                                        disabled="disabled">
                                                        Sold out
                                                    </button>
                                                </div>
                                    ...
                                    <p class="infolinks d-flex-center mt-2 mb-3">
                                        <a class="btn add-to-wishlist d-none" href="my-wishlist.html"><i
                                                class="icon an an-heart-l me-1" aria-hidden="true"></i>
                                            <span>Add to Wishlist</span></a>
                                        <a class="btn add-to-wishlist" href="compare-style1.html"><i
                                                class="icon an an-sync-ar me-1" aria-hidden="true"></i>
                                            <span>Add to Compare</span></a>
                                        <a class="btn shippingInfo" href="#ShippingInfo"><i
                                                class="icon an an-paper-l-plane me-1"></i> Delivery
                                            &amp; Returns</a>
                                        <a class="btn emaillink me-0" href="#productInquiry">
                                            <i class="icon an an-question-cil me-1"></i> Ask A
                                            Question</a>
                                    </p>
                                ...
                                <div class="freeShipMsg" data-price="199">
                                    <i class="icon an an-truck" aria-hidden="true"></i>SPENT
                                    <b class="freeShip"><span class="money" data-currency-usd="$199.00"
                                            data-currency="USD">$199.00</span></b>
                                    MORE FOR FREE SHIPPING
                                </div>
                                <div class="shippingMsg">
                                    <i class="icon an an-clock-r" aria-hidden="true"></i>Estimated
                                    Delivery Between <b id="fromDate">Wed, May 1</b> and
                                    <b id="toDate">Tue, May 7</b>.
                                </div>
                                <div class="userViewMsg" data-user="20" data-time="11000">
                                    <i class="icon an an-eye-r" aria-hidden="true"></i><strong
                                        class="uersView">21</strong> People are Looking for
                                    this Product
                                </div>
                                <div class="trustseal-img mt-4">
                                    <img src="assets/images/powerby-cards.jpg" alt="powerby cards" />
                                </div>
                                <!-- End Product Info -->
                            </div>
                        </div>
                    ...
                    <!--Product Nav-->
                    <a href="product-outofstock.html" class="product-nav prev-pro d-flex-center justify-content-between"
                        title="Previous Product">
                        <span class="details">
                            <span class="name">Mini Sleev Top</span>
                            <span class="price">$199.00</span>
                        </span>
                        <span class="img"><img src="assets/images/products/product-6-5.jpg"
                                alt="product" /></span>
                    </a>
                    <a href="product-layout1.html" class="product-nav next-pro d-flex-center justify-content-between"
                        title="Next Product">
                        <span class="img"><img src="assets/images/products/product-1.jpg"
                                alt="product" /></span>
                        <span class="details">
                    ...
                    <div class="tabs-listing mt-2 mt-md-5">
                        <ul class="product-tabs list-unstyled d-flex-wrap border-bottom m-0 d-none d-md-flex">
                            ...
                            <li rel="addtional-tabs">
                                <a class="tablink">Addtional Tabs</a>
                            </li>
                        </ul>
                        <div class="tab-container">
                                ...
                                <div class="product-description">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                            <img data-src="assets/images/about/about-info-s3.jpg"
                                                src="assets/images/about/about-info-s3.jpg" alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <h3 class="tabs-ac-style d-md-none" rel="size-chart">
                                Size Chart
                            </h3>
                            <div id="size-chart" class="tab-content">
                                <h4 class="fw-bold text-center">Size Guide</h4>
                                <p class="text-center">
                                    This is a standardised guide to give you an idea of what size
                                    you will need, however some brands may vary from these
                                    conversions.
                                </p>
                                <p class="text-center">
                            ...
                            <h3 class="tabs-ac-style d-md-none" rel="shipping-return">
                                Shipping &amp; Return
                            </h3>
                                            ...
                                            <fieldset class="spr-form-contact">
                                                ...
                                                <div class="spr-form-review-body form-group">
                                                    <label class="spr-form-label" for="message">Body of Review
                                                        <span class="spr-form-review-body-charactersremaining">(1500)
                                            ...
                                            <div class="review-inner">
                                                <div class="spr-review">
                                                    <div class="spr-review-header">
                                                        <span class="product-review spr-starratings"><span
                                                                class="reviewLink"><i class="icon an an-star"></i><i
                                                                    class="icon an an-star mx-1"></i><i
                                                ...
                                                <div class="spr-review">
                                                    <div class="spr-review-header">
                                                        ...
                                                        <span class="spr-review-header-byline"><strong>Diva</strong> on
                            ...
                            <h3 class="tabs-ac-style d-md-none" rel="addtional-tabs">
                                Addtional Tabs
                            </h3>
            ...
            <div id="ShippingInfo" class="mfpbox mfp-with-anim mfp-hide">
                ...
                <p>
                    ...
                    items. We have an easy and hassle free return policy. Please look at
                    our Delivery &amp; Returns section for further information.
                </p>
            </div>
            <!-- End Shipping Popup-->
            ...
            <!--360Degree Product Popup-->
            <div id="threesixty" class="mfpbox mfp-hide threesixty mfp-with-anim">
                <div class="spinner"><span>0%</span></div>
                <ul class="threesixty_images"></ul>
                <button title="Close (Esc)" type="button" class="mfp-close">×</button>
            </div>
            <!--End 360Degree Product Popup-->
            ...
            <!-- Threesixty JS -->
            <script src="{{ asset('assets/js/vendor/jquery.threesixty.min.js') }}"></script>
                ...
                function init() {
                    ...
                    if (!$(".threesixty_images li").length) {
                        product1 = $(".threesixty").ThreeSixty({
                            ...
                            imagePath: "{{ asset('assets/images/products/360degree-images/') }}", // path of the image assets
    ...
    <!-- Mirrored from template.annimexweb.com/optimal/prodcut-360-degree-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 May 2022 14:58:52 GMT -->
